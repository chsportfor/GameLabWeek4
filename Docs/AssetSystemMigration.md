...
> 후속 작업에서 GraphicsManager를 제거하고 개별 렌더링 파이프라인으로 전환했다. 현재 구조와 추가 삭제 목록은 [RenderingPipelineMigration.md](RenderingPipelineMigration.md)를 참고한다. 아래는 에셋 전환 당시의 기록이다.
